...
export interface ApiMedicineMedicine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Added_by: Schema.Attribute.Relation<'manyToOne', 'api::doctor.doctor'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dosage: Schema.Attribute.Blocks & Schema.Attribute.Required;
    image: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    interactions: Schema.Attribute.Blocks & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    medicines: Schema.Attribute.Relation<
      'manyToMany',
      'api::medicine.medicine'
    >;
    name: Schema.Attribute.String &
    ...
    publishedAt: Schema.Attribute.DateTime;
    sideEffects: Schema.Attribute.Blocks & Schema.Attribute.Required;
    similarmedicines: Schema.Attribute.Relation<
      'manyToMany',
      'api::medicine.medicine'
    >;
    symptoms: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
